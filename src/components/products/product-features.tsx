    ...
    <div className="space-y-20">
      ...
      >
        <div className="space-y-6">
          <div className="text-center p-6 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20 rounded-3xl border-2 border-red-200 dark:border-red-800">
            ...
            <div className="space-y-4">
              {comparisons[0].problems.map((problem, index) => (
                <motion.div
                  key={index}
                  className="text-left p-4 bg-white/50 dark:bg-red-950/30 rounded-xl"
        ...
        <div className="space-y-6">
          <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-3xl border-2 border-green-200 dark:border-green-800">
            ...
            <div className="space-y-4">
              {comparisons[1].solutions.map((solution, index) => (
                <motion.div
                  key={index}
                  className="text-left p-4 bg-white/50 dark:bg-green-950/30 rounded-xl"
                  initial={{ opacity: 0, x: 20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.4, delay: index * 0.1 }}
                  viewport={{ once: true }}
      ...
      <div className="space-y-12">
        <div className="text-center">
          <h3 className="text-3xl font-bold mb-4">🏆 Vantagens Competitivas</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {competitiveAdvantages.map((advantage, index) => (
            <motion.div
              key={index}
              className="text-center p-8 rounded-3xl bg-gradient-to-br from-card to-card/70 border hover:shadow-xl transition-all duration-300"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              whileHover={{ y: -5 }}
            >
              <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
      ...
      <motion.div
        className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 rounded-3xl p-8 lg:p-12 text-center relative overflow-hidden"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
          ...
          <div className="space-y-2">
            <div className="text-3xl font-bold text-primary">30dias</div>
