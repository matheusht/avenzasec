  ...
  return (
    <div className="space-y-16">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
        {features.map((feature, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="group flex items-start gap-4 p-6 rounded-3xl bg-gradient-to-br from-card via-card/90 to-card/70 hover:from-primary/5 hover:via-accent/5 hover:to-primary/5 transition-all duration-300 border hover:border-primary/20 hover:shadow-xl"
            whileHover={{ y: -5 }}
          >
            <div className="w-10 h-10 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center mt-1 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
              <svg
            ...
            <span className="text-foreground font-semibold text-lg leading-relaxed group-hover:text-primary transition-colors">
              {feature}
            </span>
          </motion.div>
        ))}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 rounded-3xl p-8 lg:p-12 text-center max-w-4xl mx-auto border border-primary/10"
      >
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <h3 className="text-2xl font-bold">Implementação Completa</h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="space-y-1">
            ...
            <div className="font-semibold">Setup Automático</div>
          ...
          <div className="space-y-1">
            ...
            <div className="font-semibold">Treinamento Incluído</div>
            <div className="text-sm text-muted-foreground">
          ...
          <div className="space-y-1">
            ...
            <div className="font-semibold">Lançamento Rápido</div>
            <div className="text-sm text-muted-foreground">
